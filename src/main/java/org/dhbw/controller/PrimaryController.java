...
public class PrimaryController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        ImageView addStudentImageView = new ImageView(new Image(clazz.getResourceAsStream("/org/dhbw/controller/images/addStudentHat.png")));
        addStudentImageView.setFitHeight(50);
        addStudentImageView.setFitWidth(50);
        addStudent.setGraphic(addStudentImageView);

        ImageView addLectureImageView = new ImageView(new Image(clazz.getResourceAsStream("/org/dhbw/controller/images/addDocent.png")));
        addLectureImageView.setFitWidth(50);
        addLectureImageView.setFitHeight(50);
        addLecture.setGraphic(addLectureImageView);

        ImageView addCourseImageView = new ImageView(new Image(clazz.getResourceAsStream("/org/dhbw/controller/images/addCourse.png")));
        addCourseImageView.setFitHeight(50);
        addCourseImageView.setFitWidth(50);
        addCourse.setGraphic(addCourseImageView);

        ImageView addCompanyImageView = new ImageView(new Image(clazz.getResourceAsStream("/org/dhbw/controller/images/addCompany.png")));
        addCompanyImageView.setFitWidth(50);
        addCompanyImageView.setFitHeight(50);
        addCompany.setGraphic(addCompanyImageView);

        ImageView addRoomImageView = new ImageView(new Image(clazz.getResourceAsStream("/org/dhbw/controller/images/addRoom.png")));
        addRoomImageView.setFitWidth(50);
        addRoomImageView.setFitHeight(50);
        addRoom.setGraphic(addRoomImageView);

        ImageView showTableImageView = new ImageView(new Image(clazz.getResourceAsStream("/org/dhbw/controller/images/showTable.png")));
        ...
        buttonLanguage.setText(Language.getLocale().getLanguage());
